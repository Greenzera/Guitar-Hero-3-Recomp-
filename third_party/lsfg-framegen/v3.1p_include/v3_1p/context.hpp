...
#if defined(_WIN32)
        ///
        /// Variante Windows: as imagens chegam como HANDLEs opacos Win32
        /// (VK_KHR_external_memory_win32) em vez de file descriptors.
        ///
        Context(Vulkan& vk,
...
#if defined(_WIN32)
        /// Variante Windows do present: semaforos como HANDLEs opacos Win32.
        void present(Vulkan& vk,
