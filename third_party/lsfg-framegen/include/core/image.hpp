...
#if defined(_WIN32)
        ///
        /// Variante Windows: importa memoria partilhada por HANDLE opaco Win32
        /// (VK_KHR_external_memory_win32) em vez de fd. Usada na integracao no
        /// gh3, onde o guest output do rexglue e exportado como HANDLE.
        /// Se win32Handle == nullptr, aloca memoria propria (sem import).
        ///
        Image(const Core::Device& device, VkExtent2D extent, VkFormat format,
