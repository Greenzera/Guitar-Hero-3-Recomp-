...
#if defined(_WIN32)
        ///
        /// Importa um semaforo a partir de um HANDLE opaco Win32
        /// (VK_KHR_external_semaphore_win32), equivalente ao caminho de fd.
        /// win32Handle == nullptr cria um semaforo binario nao partilhado.
        /// O chamador continua dono do HANDLE e deve fecha-lo.
        ///
        /// @throws LSFG::vulkan_error se a criacao/importacao falhar.
        ///
        Semaphore(const Core::Device& device, void* win32Handle);
#endif
